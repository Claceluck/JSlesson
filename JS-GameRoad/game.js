...
// Запрещаем открывать контекстное меню, чтобы улучшить игру на мобильных устройствах
...
var player = new Car("images/car.png", canvas.width / 2, canvas.height / 2, true); //Объект, которым управляет игрок, — тут будет указан номер объекта в массиве objects
...
function Update() //Обновление игры
{
	...
	if(RandomInteger(0, 10000) > 9700) // добавление машин
	{
...
function RandomInteger(min, max) // Генерация игровых объектов
{
